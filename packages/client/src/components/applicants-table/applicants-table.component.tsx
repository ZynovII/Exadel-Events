...
const headCells: HeadCell[] = [
  ...
  { id: 'techStack', disablePadding: false, label: 'Tech Stack' },
...
function EnhancedTableHead(props: EnhancedTableProps) {
  ...
  const createSortHandler =
    (property: keyof Applicant) => (event: React.MouseEvent<unknown>) => {
...
export default function EnhancedTable() {
  ...
  const [orderBy, setOrderBy] = React.useState<keyof Applicant>('techStack');
